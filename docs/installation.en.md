...
Set `PPS_VERSION=v0.3.0` or `PPS_INSTALL_DIR="$HOME/bin"` to override the version or destination.
...
For a downloaded script, use parameters such as `./install.ps1 -Version v0.3.0 -InstallDir C:\Tools\PPS`.
