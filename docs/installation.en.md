...
Set `PPS_VERSION=v0.7.0` to install a specific version. To change the destination, set `PPS_INSTALL_DIR` to a directory already on PATH.
...
For a downloaded script, use parameters such as `./install.ps1 -Version v0.7.0 -InstallDir C:\Tools\PPS`.
