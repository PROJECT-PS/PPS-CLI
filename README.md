...
공식 커뮤니티 저장소 등록이 완료된 뒤 다음 명령을 사용할 수 있습니다.
...
패키지 관리자별 현황과 공식 저장소 등록 절차는 [패키지 관리자 안내](docs/package-managers.md)를 참고하세요. 수동 설치, 체크섬 검증과 삭제 방법은 [설치 상세 문서](docs/installation.md)에 있습니다.
...
설치 스크립트를 다시 실행하거나 사용 중인 패키지 관리자의 업그레이드 명령을 사용하세요. 모든 GitHub Release에는 `checksums.txt`가 포함되며 설치 스크립트는 SHA-256 체크섬을 검증합니다.
