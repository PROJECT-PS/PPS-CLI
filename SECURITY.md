...
- 영향받는 PPS CLI 버전, 운영체제와 아키텍처
- 재현 절차와 예상 영향
- 개념 증명 자료(민감한 토큰과 개인정보는 제거)
- 공개 가능 시점에 대한 제안

접수 확인 후 영향도와 수정 일정을 비공개 채널에서 안내합니다.
...
Include the affected version, operating system and architecture, reproduction steps, expected impact, and a sanitized proof of concept. We will acknowledge the report and coordinate remediation and disclosure privately.
